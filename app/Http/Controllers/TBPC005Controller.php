...
use App\Services\ExportServiceNameDecision as ExportService;
use Illuminate\Support\Facades\Storage;


class TBPC005Controller extends Controller
{
    public function exportPdf(string $id)
    {

        $file_name = '名義貸与決裁書_' . date('YmdHis');
        $export_service = new ExportService();
    
        $export_service->makePdf($file_name, $id);
