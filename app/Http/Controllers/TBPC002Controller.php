...
use App\Services\ExportServiceDirector as ExportService;
use Illuminate\Support\Facades\Storage;


class TBPC002Controller extends Controller
{
    public function exportPdf(string $id, string $name_flg)
    {

        $file_name = '局長会資料_' . date('YmdHis');
        $export_service = new ExportService();
    
        $export_service->makePdf($file_name, $id, $name_flg);
