...
use App\Services\ExportServiceYearCalender as ExportService;
use Illuminate\Support\Facades\Storage;


class TBPA001Controller extends Controller
{
    public function exportPdf(string $yyyy)
    {

        $file_name = '年間予定表_' . date('YmdHis');
        $export_service = new ExportService();
    
        $export_service->makePdf($file_name, $yyyy);
